...
using TWrite = Omi.Xna.Collada.Model.Geometry.Mesh;
...
namespace Omi.Xna.Collada.Importer.Serialization
{
    ...
    public class MeshWriter : ContentTypeWriter<TWrite>
    {
        ...
        {
            return "Omi.Xna.Collada.Model.Deserialization.MeshReader, OmiXnaColladaModel";
        }
        ...
        void WriteMeshParts(ContentWriter output, Mesh mesh)
        {
            ...
            {                
                output.Write(part.MaterialName != null ? part.MaterialName : "");
