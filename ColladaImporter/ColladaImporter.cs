...
namespace Omi.Xna.Collada.Importer
{
    ...
    /// ColladaData class.
    /// </summary>
    [ContentImporter(".dae", DisplayName = "COLLADA Custom Model Importer", DefaultProcessor = "ColladaProcessor")]
    public class ColladaImporter : ContentImporter<IntermediateModel>
    {
        /// <summary>
        ...
        public override IntermediateModel Import(string filename, ContentImporterContext context)
        {
