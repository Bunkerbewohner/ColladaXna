...
namespace Omi.Xna.Collada.Model.Geometry
{
    ...
    public class VertexInstructions
    {
        ...
        /// <summary>
        /// Color indices refering to Source
        /// </summary>
        ...
        /// <summary>
        /// Binormal indices refering to Source
        /// May be null or empty
        /// </summary>
        public int[] BinormalIndices;
        ...
        /// <summary>
        /// Is true if there color indices
        /// </summary>
        public bool HasColors
        {
            get { return ColorIndices != null && ColorIndices.Length > 0; }
        }
        ...
        /// <summary>
        /// Is true if there are binormal indices
        /// </summary>
        public bool HasBinormals
        {
            get { return BinormalIndices != null && BinormalIndices.Length > 0; }
        }
        ...
        /// <summary>
        /// Copies color indices into the instruction set.
        /// The source indices array must be the array of all indices
        /// combined just as found in the COLLADA file (&lt;p&gt).
        /// </summary>
        /// <param name="sourceIndices">Index list as in COLLADA file</param>
        /// <param name="sourceOffset"></param>
        /// <param name="count"></param>
        public void CopyColors(int[] sourceIndices, int sourceOffset, int count)
        {
            CopyIndices(sourceIndices, sourceOffset, out ColorIndices, count);
        }
        ...
        /// <summary>
        /// Copies binormal indices into the instruction set.
        /// The source indices array must be the array of all indices
        /// combined just as found in the COLLADA file (&lt;p&gt).
        /// </summary>
        /// <param name="sourceIndices">Index list as in COLLADA file</param>
        /// <param name="sourceOffset"></param>
        /// <param name="count"></param>
        public void CopyBinormals(int[] sourceIndices, int sourceOffset, int count)
        {
            CopyIndices(sourceIndices, sourceOffset, out BinormalIndices, count);
        }
        ...
        /// <summary>
        /// Returns the color from the vertex source referenced
        /// by the i-th position index (ColorIndices[i]).
        /// If no color indices were defined a Magenta color
        /// is returned.
        /// </summary>
        /// <param name="i">index of the index in ColorIndices</param>
        /// <returns>The referenced color or Magenta</returns>
        public Color FetchColor(int i)
        {
            if (Source.Colors == null || ColorIndices == null)
                return new Color(1, 0, 1, 1);
            else
                return Source.Colors[ColorIndices[i]];
        }
        ...
        /// <summary>
        /// Returns the binormal from the vertex source referenced
        /// by the i-th binormal index (BinormalIndices[i]).
        /// If no binormal indices were defined a Vector3 containing
        /// only NaN is returned.
        /// </summary>
        /// <param name="i">index of the index in BinormalIndices</param>
        /// <returns>The referenced binormal or a Vector3 of NaNs</returns>
        public Vector3 FetchBinormal(int i)
        {
            if (Source.Binormals == null || BinormalIndices == null)
                return new Vector3(float.NaN, float.NaN, float.NaN);
            else
                return Source.Binormals[BinormalIndices[i]];
        }
