//--------------------------------------------------------------------------------
// Shader Generic-AcBlinnDcEcOpScSp, generated by EffectCode at 08.08.2011 01:22:18
//--------------------------------------------------------------------------------
...
float3 DiffuseColor = float3(1,0.7686275,0.5921569);
float3 SpecularColor = float3(0.3960784,0.3058824,0.254902);
float SpecularPower = 0.31402;
float Opacity = 1;
...
float3 AmbientLightColor = float3(0.6980392, 0.6980392, 1);
//--------------------------------------------------------------------------------
// Texture Samplers
//--------------------------------------------------------------------------------
