//--------------------------------------------------------------------------------
// Shader Generic-AcEcNdOpPhongScSpTx, generated by EffectCode at 08.08.2011 01:22:18
//--------------------------------------------------------------------------------
...
Texture DiffuseMap;
float3 SpecularColor = float3(0.5019608,0.5019608,0.5019608);
float SpecularPower = 9.999999;
float Opacity = 1;
Texture NormalMap;
